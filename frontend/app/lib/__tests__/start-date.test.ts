...
describe("validateDueDate", () => {
  ...
  it("returns error when dueDate is before startDate", () => {
    expect(validateDueDate("2026-07-28", "09:00", "2026-07-25", "16:00")).toBe(
  ...
  it("returns error when same day and dueTime is before startTime", () => {
    expect(validateDueDate("2026-07-28", "15:00", "2026-07-28", "13:00")).toBe(
      "Due time can't be before the start time on the same day."
    )
  })
